...
export const projects = [
  ...
  },
  {
    ...
    nextProject: 3,
    nextProjectName: "Sabores Brasileiros",
    nextProjectSlogan: "Menu online para restaurante",
  },
  {
    id: 3,
    name: "Sabores Brasileiros",
    slogan: "Menu online para restaurante",
    bgSrc: "https://i.imgur.com/r0lgjxH.png",
    about:
      "Neste menu online, os usuários podem explorar uma seleção de pratos típicos do Brasil, adicioná-los facilmente à sua sacola virtual e visualizar o valor total da compra. A praticidade se estende à capacidade de editar a quantidade de itens na sacola, remover pratos ou fazer ajustes conforme desejado. Com um processo de pedidos intuitivo e flexível, o Menu Online proporciona uma maneira fácil e adaptável de desfrutar dos autênticos sabores brasileiros no conforto de casa.",
    images: [
      "https://i.imgur.com/mruLJGG.png",
      "https://i.imgur.com/eAzyZno.png",
    ],
    webSiteUrl: "https://sabores-brasileiros-next.vercel.app",
    repository: "https://github.com/ArlissonC/sabores-brasileiros-next",
